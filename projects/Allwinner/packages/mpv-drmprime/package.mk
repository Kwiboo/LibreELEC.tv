...
PKG_DEPENDS_TARGET="toolchain ffmpeg libass libdrm alsa $OPENGLES"
...
PKG_CONFIGURE_OPTS_TARGET="--disable-libsmbclient --disable-apple-remote --prefix=/usr --enable-drmprime --enable-drm --enable-gbm --enable-egl-drm --disable-vaapi"
...
configure_target() {
  cd $PKG_BUILD
    ./bootstrap.py
    CFLAGS="$CFLAGS -D__GBM__" ./waf configure $PKG_CONFIGURE_OPTS_TARGET
}
